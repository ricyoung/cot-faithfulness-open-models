...
This paper presents the first systematic, cross-family evaluation of chain-of-thought
...
sycophancy 53.9\%) proving hardest to acknowledge and thinking tokens proving
far more faithful (87.5\%) than answer text (28.6\%).
...
scale, and models develop an internal capacity to detect hint influence, as
evidenced by thinking-token faithfulness rates averaging 87.5\%, that is
systematically suppressed in their externally visible outputs. On the practical
...
between the two classifier pipelines.
