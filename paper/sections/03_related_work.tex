...
evaluations. Perez et al.~\cite{perez2022discovering} discovered that larger
models exhibit \emph{more} sycophancy, an inverse scaling phenomenon relevant to
our cross-scale analysis from 7B to 1T parameters.
...
faithfulness gaps we measure may underestimate the true divergence between stated
and actual reasoning. Greenblatt et al.~\cite{greenblatt2024alignment} showed that
Claude 3 Opus strategically fakes alignment during training, producing CoT that is
deliberately strategic rather than faithfully explanatory, while Hubinger et
...
fine-tuning, data-centric), and scales (8B to over 1T parameters), with fully
