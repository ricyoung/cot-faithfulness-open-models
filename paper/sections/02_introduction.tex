...
(GRPO, DPO) to distillation, data-centric methods, and hybrid approaches. No
...
The present study addresses this gap with the first large-scale, cross-family
...
influenced cases. Two primary hypotheses
...
category-specific blind spots in CoT monitoring. A secondary hypothesis is also
examined: (H3)~models trained with outcome-based reinforcement learning exhibit
lower faithfulness than those trained with process supervision or data-centric
methods, as outcome-based training may incentivize correct answers without
requiring honest reasoning. All code, prompts, model outputs, and faithfulness
